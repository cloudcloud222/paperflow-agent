...
# ---------- 第4步：生成节点正文 ----------
writer = NodeWriter()
node_text = writer.write_node_stream(
    topic=topic,
    goal=goal,
...
output_path = output_dir / "node_output.txt"
output_path.write_text(node_text, encoding="utf-8")
